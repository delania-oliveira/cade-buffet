class BasePricesController < ApplicationController
  ...
  def new
    ...
    redirect_to root_path, alert: 'Você não tem permissão para criar um preço-base para esse evento'
    end
  end
  ...
  def edit
    ...
    if @base_price.event_type.buffet == current_user.buffet
      ...
      notice: 'Você não tem permissão para editar o preço-base que pertence a um evento de um buffet de outro Dono de Buffet'
    end
  end
